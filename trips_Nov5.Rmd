...
p1 = ggplot(data = trips, aes(group = Month, y = trip_percentage)) +
...
p2 = ggplot(data = trips, aes(group = weekday, y = trip_percentage)) +
...
p3 = ggplot(data = trips, aes(group = Month, y = Number.of.Trips)) +
  geom_boxplot() + ggtitle('boxplot of trips by month')

p3

p4 = ggplot(data = trips, aes(group = weekday, y = Number.of.Trips)) +
